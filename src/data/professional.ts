...
export const professional: ITimeline[] = [
     ...
     {
          description: "Desde 2023, atuando no desenvolvimento, manutenção e suporte de uma plataforma Web voltada a consultas online, aquisição de exames e prestação de serviços na área da saúde",
